...
#
# Created: Mon Sep 23 11:50:45 2013
...
class Ui_PrefDialog(object):
    def setupUi(self, PrefDialog):
        ...
        self.keditlistbox = KEditListBox(self.habitatTab)
        self.keditlistbox.setObjectName(_fromUtf8("keditlistbox"))
        self.gridLayout_2.addWidget(self.keditlistbox, 0, 0, 1, 1)
        ...
        self.keditlistwidget = KEditListWidget(self.substrateTab)
        self.keditlistwidget.setObjectName(_fromUtf8("keditlistwidget"))
        self.gridLayout_4.addWidget(self.keditlistwidget, 0, 0, 1, 1)
    ...
    def retranslateUi(self, PrefDialog):
        ...
        self.label.setText(QtGui.QApplication.translate("PrefDialog", "Hab1", None, QtGui.QApplication.UnicodeUTF8))
