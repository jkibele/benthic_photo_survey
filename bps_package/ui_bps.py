...
#
# Created: Mon Feb  4 15:44:09 2013
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.habAndSubstBox = QtGui.QGroupBox(self.centralwidget)
        self.habAndSubstBox.setMinimumSize(QtCore.QSize(240, 0))
        self.habAndSubstBox.setMaximumSize(QtCore.QSize(240, 16777215))
        self.habAndSubstBox.setTitle(QtGui.QApplication.translate("MainWindow", "Habitat and Substrate", None, QtGui.QApplication.UnicodeUTF8))
        self.habAndSubstBox.setObjectName(_fromUtf8("habAndSubstBox"))
        self.horizontalLayout_2 = QtGui.QHBoxLayout(self.habAndSubstBox)
        self.horizontalLayout_2.setObjectName(_fromUtf8("horizontalLayout_2"))
        self.habitatListWidget = QtGui.QListWidget(self.habAndSubstBox)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Maximum, QtGui.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.habitatListWidget.sizePolicy().hasHeightForWidth())
        self.habitatListWidget.setSizePolicy(sizePolicy)
        self.habitatListWidget.setMaximumSize(QtCore.QSize(130, 16777215))
        self.habitatListWidget.setToolTip(QtGui.QApplication.translate("MainWindow", "Double Click to set habitat", None, QtGui.QApplication.UnicodeUTF8))
        self.habitatListWidget.setObjectName(_fromUtf8("habitatListWidget"))
        self.horizontalLayout_2.addWidget(self.habitatListWidget)
        self.substrateListWidget = QtGui.QListWidget(self.habAndSubstBox)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Maximum, QtGui.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.substrateListWidget.setMaximumSize(QtCore.QSize(130, 16777215))
        ...
        self.horizontalLayout_2.addWidget(self.substrateListWidget)
        self.gridLayout_2.addWidget(self.habAndSubstBox, 2, 1, 1, 1)
        ...
        QtCore.QObject.connect(self.habitatListWidget, QtCore.SIGNAL(_fromUtf8("doubleClicked(QModelIndex)")), MainWindow.setHabitat)
